CREATE TABLE WAREHOUSE (
  ...
  W_ESCROWYTD FLOAT DEFAULT NULL,
...
CREATE TABLE DISTRICT (
  ...
  D_ESCROWYTD FLOAT DEFAULT NULL,
...
CREATE TABLE CUSTOMER (
  ...
  C_ESCROWBALANCE FLOAT DEFAULT NULL,
  C_ESCROWYTD_PAYMENT FLOAT DEFAULT NULL,
  C_ESCROWPAYMENT_CNT INTEGER DEFAULT NULL,
  C_ESCROWDELIVERY_CNT INTEGER DEFAULT NULL,
  C_DATA VARCHAR(500),
...
CREATE TABLE STOCK (
  ...
  S_ESCROWQUANTITY INTEGER DEFAULT '0' NOT NULL,
  ...
  S_ESCROWYTD INTEGER DEFAULT NULL,
  S_ESCROWORDER_CNT INTEGER DEFAULT NULL,
  S_ESCROWREMOTE_CNT INTEGER DEFAULT NULL,
