...
APPNAME="tpcc"
VOLTJAR=`ls ../mar21P/voltdb/voltdb-2.*.jar`
CLASSPATH="$VOLTJAR:../mar21P/lib" #:./obj/com:./obj/com/procedures"
VOLTDB="../mar21P/bin/voltdb"
VOLTCOMPILER="../mar21P/bin/voltcompiler"
LICENSE="../mar21P/voltdb/license.xml"
LEADER="localhost"
