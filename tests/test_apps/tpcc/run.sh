...
APPNAME="tpcc"
VOLTJAR=`ls ../mar18/voltdb/voltdb-2.*.jar`
CLASSPATH="$VOLTJAR:../mar18/lib" #:./obj/com:./obj/com/procedures"
VOLTDB="../mar18/bin/voltdb"
VOLTCOMPILER="../mar18/bin/voltcompiler"
LICENSE="../mar18/voltdb/license.xml"
LEADER="localhost"
