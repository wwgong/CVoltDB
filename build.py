...
if CTX.LEVEL == "MEMCHECK":
    CTX.EXTRAFLAGS += " -g3 -rdynamic -DDEBUG -DMEMCHECK -DVOLT_LOG_LEVEL=100"
...
CTX.INPUT['storage'] = """
 ...
 DataConflictException.cpp
 EscrowOutOfBoundException.cpp
 ...
 PersistentTableUndoEscrowUpdateAction.cpp
