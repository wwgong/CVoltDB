...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        myApp.callProcedure("Insert2", 1, 100);
...
//        myApp.callProcedure("BatchInsert");
//        
...
//        
//        
//        final ClientResponse response2 = myApp.callProcedure("ReplicatedTable", 
//        		"abc@t.com", "Abc", "T", "English");
//        if (response2.getStatus() != ClientResponse.SUCCESS){
//            System.err.println(response2.getStatusString());
//            System.exit(-1);
//        }
//        final VoltTable results2[] = response2.getResults();
//        for(VoltTable t : results2) {
