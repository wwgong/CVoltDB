...
// GWW: escrow exception
const char* SQLException::integrity_data_conflict = "24000";
const char* SQLException::escrow_out_of_bound = "25000";
const char* SQLException::volt_operation_not_supported = "99999";
