...
public abstract class ExecutionEngine implements FastDeserializer.DeserializationMonitor {
    ...
    /** Run a plan fragment */
    // GWW: add parameter executedPlanNodes, isCVoltDB
    abstract public DependencyPair executePlanFragment(
        ...
        long executedPlanNodes, boolean isCVoltDB, 
    ...
    abstract public VoltTable[] executeQueryPlanFragmentsAndGetResults(long[] planFragmentIds,
                                                                       ...
                                                                       long txnId, long lastCommittedTxnId,
                                                                       long undoQuantumToken,
                                                                       long startBatch, long startPlanNode, boolean isCVoltDB) 
                                                                       throws EEException;
    ...
    // GWW
    public boolean release2UndoToken(long txnId, long beginUndoToken, long endUndoToken) {return false;}
    public boolean undo2UndoToken(long txnId, long beginUndoToken, long endUndoToken) {return false;}
    ...
    */
     ...
     * @return error code
     */
    // GWW: add 2 parameters
    protected native int nativeExecutePlanFragment(long pointer, long planFragmentId,
            int outputDepId, int inputDepId, long txnId, long lastCommittedTxnId, 
            long executedPlanNodes, boolean isCVoltDB, long undoToken);
    ...
    // GWW:
    protected native boolean nativeRelease2UndoToken(long pointer, long txnId, long beginUndoToken, long endUndoToken);
    protected native boolean nativeUndo2UndoToken(long pointer, long txnId, long beginUndoToken, long endUndoToken);
