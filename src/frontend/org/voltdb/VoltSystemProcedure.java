...
public abstract class VoltSystemProcedure extends VoltProcedure {
    ...
    protected VoltTable[] executeSysProcPlanFragments(
        ...
        TransactionState txnState = getCurrentTxn();
    	...
    	((MultiPartitionParticipantTxnState)txnState).resumeExecutionSite();
    	((MultiPartitionParticipantTxnState) txnState).waitResult();
        
        Map<Integer, List<VoltTable>> mapResults = txnState.getPreviousStackFrameDropDependendencies();
